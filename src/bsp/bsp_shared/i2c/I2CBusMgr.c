 ...
 * machine is going next.
 */
static QState I2CBusMgr_BusBeingUsed(I2CBusMgr * const me, QEvt const * const e);
 ...
 * machine is going next.
 */
static QState I2CBusMgr_SetupI2CDevice(I2CBusMgr * const me, QEvt const * const e);
 ...
 * machine is going next.
 */
static QState I2CBusMgr_Writing(I2CBusMgr * const me, QEvt const * const e);
 ...
 * machine is going next.
 */
static QState I2CBusMgr_Reading(I2CBusMgr * const me, QEvt const * const e);
 ...
 * machine is going next.
 */
static QState I2CBusMgr_WaitFor_I2C_EV6_R(I2CBusMgr * const me, QEvt const * const e);
 ...
 * machine is going next.
 */
static QState I2CBusMgr_WaitFor_I2C_EV5_R(I2CBusMgr * const me, QEvt const * const e);
 ...
 * machine is going next.
 */
static QState I2CBusMgr_WaitFor_I2C_EV5_REC(I2CBusMgr * const me, QEvt const * const e);
 ...
 * machine is going next.
 */
static QState I2CBusMgr_WaitFor_I2C_EV6_REC(I2CBusMgr * const me, QEvt const * const e);
 ...
 * machine is going next.
 */
static QState I2CBusMgr_StartI2CComm(I2CBusMgr * const me, QEvt const * const e);
...
static QState I2CBusMgr_Busy(I2CBusMgr * const me, QEvt const * const e) {
    ...
    switch (e->sig) {
        ...
        /* ${AOs::I2CBusMgr::SM::Active::Busy::I2C_TIMEOUT} */
        case I2C_TIMEOUT_SIG: {
            ERR_printf("I2C timeout occurred\n");
            status_ = Q_TRAN(&I2CBusMgr_Idle);
            break;
        }
        /* ${AOs::I2CBusMgr::SM::Active::Busy::I2C_READ_START, I2C_WRITE_START} */
 ...
 * machine is going next.
 */
/*${AOs::I2CBusMgr::SM::Active::Busy::WaitForBusRecovery} ..................*/
static QState I2CBusMgr_WaitForBusRecovery(I2CBusMgr * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        /* ${AOs::I2CBusMgr::SM::Active::Busy::WaitForBusRecovery} */
 ...
 * machine is going next.
 */
/*${AOs::I2CBusMgr::SM::Active::Busy::WaitForBusRecovery::TogglingSCL} .....*/
static QState I2CBusMgr_TogglingSCL(I2CBusMgr * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        /* ${AOs::I2CBusMgr::SM::Active::Busy::WaitForBusRecovery::TogglingSCL} */
        ...
        /* ${AOs::I2CBusMgr::SM::Active::Busy::WaitForBusRecovery::TogglingSCL::I2C_CHECK_EV} */
        case I2C_CHECK_EV_SIG: {
            ...
            /* ${AOs::I2CBusMgr::SM::Active::Busy::WaitForBusRecovery::TogglingSCL::I2C_CHECK_EV::[BusFree?]} */
            ...
            /* ${AOs::I2CBusMgr::SM::Active::Busy::WaitForBusRecovery::TogglingSCL::I2C_CHECK_EV::[else]} */
            else {
                me->nI2CLoopTimeout--;                 /* Decrement counter */
                /* ${AOs::I2CBusMgr::SM::Active::Busy::WaitForBusRecovery::TogglingSCL::I2C_CHECK_EV::[else]::[Retriesleft?]} */
                if (me->nI2CLoopTimeout != 0) {
                    status_ = Q_TRAN(&I2CBusMgr_TogglingSCL);
                }
                /* ${AOs::I2CBusMgr::SM::Active::Busy::WaitForBusRecovery::TogglingSCL::I2C_CHECK_EV::[else]::[else]} */
                else {
 ...
 * machine is going next.
 */
/*${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed} ........................*/
static QState I2CBusMgr_BusBeingUsed(I2CBusMgr * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed} */
 ...
 * machine is going next.
 */
/*${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV6} .......*/
static QState I2CBusMgr_WaitFor_I2C_EV6(I2CBusMgr * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV6} */
        ...
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV6::I2C_CHECK_EV} */
        case I2C_CHECK_EV_SIG: {
            /* Check if EV6 has happened.  If it has, go on to the next state.  Otherwise,
             * try again until number of retries is out */
            /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV6::I2C_CHECK_EV::[EV6Happened?]} */
            if (I2C_CheckEvent( s_I2C_Bus[me->iBus].i2c_bus, I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED )) {
                /* Reset the maximum number of times to poll the I2C bus for an event */
                me->nI2CLoopTimeout = MAX_I2C_TIMEOUT;
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV6::I2C_CHECK_EV::[EV6Happened?]::[2Byteaddr?]} */
                ...
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV6::I2C_CHECK_EV::[EV6Happened?]::[1byteaddr?]} */
                else {
            ...
            /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV6::I2C_CHECK_EV::[else]} */
            else {
                me->nI2CLoopTimeout--;                 /* Decrement counter */
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV6::I2C_CHECK_EV::[else]::[Retriesleft?]} */
                if (me->nI2CLoopTimeout != 0) {
                    status_ = Q_TRAN(&I2CBusMgr_WaitFor_I2C_EV6);
                }
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV6::I2C_CHECK_EV::[else]::[else]} */
                else {
        ...
        default: {
            status_ = Q_SUPER(&I2CBusMgr_BusBeingUsed);
            break;
        }
    }
    return status_;
 ...
 * machine is going next.
 */
/*${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::SetupI2CDevice} ........*/
static QState I2CBusMgr_SetupI2CDevice(I2CBusMgr * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::SetupI2CDevice} */
        ...
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::SetupI2CDevice::I2C_EV_MASTER_MODE_SELECT} */
        case I2C_EV_MASTER_MODE_SELECT_SIG: {
            DBG_printf("Got I2C_EV_MASTER_MODE_SELECT\n");
            status_ = Q_HANDLED();
            break;
        }
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::SetupI2CDevice::I2C_EV_MASTER_TX_MODE_SELECTED} */
        case I2C_EV_MASTER_TX_MODE_SELECTED_SIG: {
            DBG_printf("Got I2C_EV_MASTER_TX_MODE_SELECTED\n");
            status_ = Q_HANDLED();
            break;
        }
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::SetupI2CDevice::I2C_SENT_MSB_ADDR} */
        case I2C_SENT_MSB_ADDR_SIG: {
            DBG_printf("Got I2C_SENT_MSB_ADDR\n");
            status_ = Q_HANDLED();
            break;
        }
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::SetupI2CDevice::I2C_SENT_LSB_ADDR} */
 ...
 * machine is going next.
 */
/*${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Writing} ...............*/
static QState I2CBusMgr_Writing(I2CBusMgr * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Writing::I2C_WRITE_DONE} */
 ...
 * machine is going next.
 */
/*${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Writing::WaitForDMAWriteDone} */
static QState I2CBusMgr_WaitForDMAWriteDone(I2CBusMgr * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Writing::WaitForDMAWriteDone} */
        ...
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Writing::WaitForDMAWriteDone::I2C_DMA_TIMEOUT} */
        ...
        default: {
            status_ = Q_SUPER(&I2CBusMgr_Writing);
            break;
        }
    }
    return status_;
 ...
 * machine is going next.
 */
/*${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Writing::WriteI2CByte} .*/
static QState I2CBusMgr_WriteI2CByte(I2CBusMgr * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Writing::WriteI2CByte} */
        ...
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Writing::WriteI2CByte::I2C_CHECK_EV} */
        case I2C_CHECK_EV_SIG: {
            /* Check if EV6 has happened.  If it has, go on to the next state.  Otherwise,
             * try again until number of retries is out */
            /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Writing::WriteI2CByte::I2C_CHECK_EV::[ReadyToWrite?]} */
            if (I2C_CheckEvent(s_I2C_Bus[me->iBus].i2c_bus, I2C_EVENT_MASTER_BYTE_TRANSMITTED)) {
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Writing::WriteI2CByte::I2C_CHECK_EV::[ReadyToWrite?]::[Nomorebytes?]} */
                ...
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Writing::WriteI2CByte::I2C_CHECK_EV::[ReadyToWrite?]::[else]} */
                else {
            ...
            /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Writing::WriteI2CByte::I2C_CHECK_EV::[else]} */
            else {
                me->nI2CLoopTimeout--;                 /* Decrement counter */
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Writing::WriteI2CByte::I2C_CHECK_EV::[else]::[Retriesleft?]} */
                if (me->nI2CLoopTimeout != 0) {
                    status_ = Q_TRAN(&I2CBusMgr_WriteI2CByte);
                }
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Writing::WriteI2CByte::I2C_CHECK_EV::[else]::[else]} */
                else {
                    ERR_printf("Timeout waiting for I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED (EV6)\n");
                    status_ = Q_TRAN(&I2CBusMgr_Idle);
                }
 ...
 * machine is going next.
 */
/*${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV5} .......*/
static QState I2CBusMgr_WaitFor_I2C_EV5(I2CBusMgr * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV5} */
        ...
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV5::I2C_CHECK_EV} */
        case I2C_CHECK_EV_SIG: {
            /* Check if EV5 has happened.  If it has, go on to the next state.  Otherwise,
             * try again until number of retries is out */
            /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV5::I2C_CHECK_EV::[EV5Happened?]} */
            ...
            /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV5::I2C_CHECK_EV::[else]} */
            else {
                me->nI2CLoopTimeout--;                 /* Decrement counter */
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV5::I2C_CHECK_EV::[else]::[Retriesleft?]} */
                if (me->nI2CLoopTimeout != 0) {
                    status_ = Q_TRAN(&I2CBusMgr_WaitFor_I2C_EV5);
                }
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV5::I2C_CHECK_EV::[else]::[else]} */
                else {
 ...
 * machine is going next.
 */
/*${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV8_MSB} ...*/
static QState I2CBusMgr_WaitFor_I2C_EV8_MSB(I2CBusMgr * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV8_MSB} */
        ...
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV8_MSB::I2C_CHECK_EV} */
        case I2C_CHECK_EV_SIG: {
            /* Check if EV6 has happened.  If it has, go on to the next state.  Otherwise,
             * try again until number of retries is out */
            /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV8_MSB::I2C_CHECK_EV::[EV8Happened?]} */
            ...
            /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV8_MSB::I2C_CHECK_EV::[else]} */
            else {
                me->nI2CLoopTimeout--;                 /* Decrement counter */
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV8_MSB::I2C_CHECK_EV::[else]::[Retriesleft?]} */
                if (me->nI2CLoopTimeout != 0) {
                    status_ = Q_TRAN(&I2CBusMgr_WaitFor_I2C_EV8_MSB);
                }
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV8_MSB::I2C_CHECK_EV::[else]::[else]} */
                else {
 ...
 * machine is going next.
 */
/*${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV8_LSB} ...*/
static QState I2CBusMgr_WaitFor_I2C_EV8_LSB(I2CBusMgr * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV8_LSB} */
        ...
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV8_LSB::I2C_CHECK_EV} */
        case I2C_CHECK_EV_SIG: {
            /* Check if EV6 has happened.  If it has, go on to the next state.  Otherwise,
             * try again until number of retries is out */
            /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV8_LSB::I2C_CHECK_EV::[EV8Happened?]} */
            if (SET == I2C_GetFlagStatus(s_I2C_Bus[me->iBus].i2c_bus, I2C_FLAG_BTF)) {
                /* Reset the maximum number of times to poll the I2C bus for an event */
                me->nI2CLoopTimeout = MAX_I2C_TIMEOUT;
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV8_LSB::I2C_CHECK_EV::[EV8Happened?]::[READ?]} */
                if (I2C_OP_READ == me->i2cCurrOperation) {
                    status_ = Q_TRAN(&I2CBusMgr_WaitFor_I2C_EV5_R);
                }
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV8_LSB::I2C_CHECK_EV::[EV8Happened?]::[WRITE?]} */
                else if (I2C_OP_WRITE == me->i2cCurrOperation) {
                    status_ = Q_TRAN(&I2CBusMgr_WaitForDMAWriteDone);
                }
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV8_LSB::I2C_CHECK_EV::[EV8Happened?]::[else]} */
                else {
                    ERR_printf("Invalid I2C operation selected: %d\n", me->i2cCurrOperation);
                    status_ = Q_TRAN(&I2CBusMgr_Idle);
                }
            }
            /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV8_LSB::I2C_CHECK_EV::[else]} */
            else {
                me->nI2CLoopTimeout--;                 /* Decrement counter */
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV8_LSB::I2C_CHECK_EV::[else]::[Retriesleft?]} */
                if (me->nI2CLoopTimeout != 0) {
                    status_ = Q_TRAN(&I2CBusMgr_WaitFor_I2C_EV8_LSB);
                }
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::WaitFor_I2C_EV8_LSB::I2C_CHECK_EV::[else]::[else]} */
                else {
                    ERR_printf("Timeout waiting for I2C_EVENT_MASTER_BYTE_TRANSMITTING (EV8)\n");
                    status_ = Q_TRAN(&I2CBusMgr_Idle);
                }
 ...
 * machine is going next.
 */
/*${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading} ...............*/
static QState I2CBusMgr_Reading(I2CBusMgr * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading} */
        ...
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::I2C_READ_DONE} */
 ...
 * machine is going next.
 */
/*${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::WaitFor_I2C_EV6_R} */
static QState I2CBusMgr_WaitFor_I2C_EV6_R(I2CBusMgr * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::WaitFor_I2C_EV6_R} */
        ...
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::WaitFor_I2C_EV6_R::I2C_CHECK_EV} */
        case I2C_CHECK_EV_SIG: {
            /* Check if EV6 has happened.  If it has, go on to the next state.  Otherwise,
             * try again until number of retries is out */
            /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::WaitFor_I2C_EV6_R::I2C_CHECK_EV::[EV6Happened?]} */
            ...
            /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::WaitFor_I2C_EV6_R::I2C_CHECK_EV::[else]} */
            else {
                me->nI2CLoopTimeout--;                 /* Decrement counter */
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::WaitFor_I2C_EV6_R::I2C_CHECK_EV::[else]::[Retriesleft?]} */
                if (me->nI2CLoopTimeout != 0) {
                    status_ = Q_TRAN(&I2CBusMgr_WaitFor_I2C_EV6_R);
                }
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::WaitFor_I2C_EV6_R::I2C_CHECK_EV::[else]::[else]} */
                else {
                    ERR_printf("Timeout waiting for I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED (EV6)\n");
                    status_ = Q_TRAN(&I2CBusMgr_Idle);
                }
        ...
        default: {
            status_ = Q_SUPER(&I2CBusMgr_Reading);
            break;
        }
    }
    return status_;
 ...
 * machine is going next.
 */
/*${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::WaitForDMAReadDone} */
static QState I2CBusMgr_WaitForDMAReadDone(I2CBusMgr * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::WaitForDMAReadDone} */
        ...
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::WaitForDMAReadDone::I2C_DMA_TIMEOUT} */
        case I2C_DMA_TIMEOUT_SIG: {
            ERR_printf("Timeout while waiting for DMA read timeout\n");
 ...
 * machine is going next.
 */
/*${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::WaitFor_I2C_EV5_R} */
static QState I2CBusMgr_WaitFor_I2C_EV5_R(I2CBusMgr * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::WaitFor_I2C_EV5_R} */
        ...
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::WaitFor_I2C_EV5_R::I2C_CHECK_EV} */
        case I2C_CHECK_EV_SIG: {
            /* Check if EV5 has happened.  If it has, go on to the next state.  Otherwise,
             * try again until number of retries is out */
            /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::WaitFor_I2C_EV5_R::I2C_CHECK_EV::[EV5Happened?]} */
            if (I2C_CheckEvent(s_I2C_Bus[me->iBus].i2c_bus, I2C_EVENT_MASTER_MODE_SELECT)) {
                DBG_printf("Selecting slave I2C Device\n");
            ...
            /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::WaitFor_I2C_EV5_R::I2C_CHECK_EV::[else]} */
            else {
                me->nI2CLoopTimeout--;                 /* Decrement counter */
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::WaitFor_I2C_EV5_R::I2C_CHECK_EV::[else]::[Retriesleft?]} */
                if (me->nI2CLoopTimeout != 0) {
                    status_ = Q_TRAN(&I2CBusMgr_WaitFor_I2C_EV5_R);
                }
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::WaitFor_I2C_EV5_R::I2C_CHECK_EV::[else]::[else]} */
                else {
                    ERR_printf("Timeout waiting for I2C_EVENT_MASTER_MODE_SELECT (EV5)\n");
                    status_ = Q_TRAN(&I2CBusMgr_Idle);
                }
 ...
 * machine is going next.
 */
/*${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::ReadI2CByte} ..*/
static QState I2CBusMgr_ReadI2CByte(I2CBusMgr * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::ReadI2CByte} */
        ...
        /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::ReadI2CByte::I2C_CHECK_EV} */
        case I2C_CHECK_EV_SIG: {
            /* Check if EV6 has happened.  If it has, go on to the next state.  Otherwise,
             * try again until number of retries is out */
            /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::ReadI2CByte::I2C_CHECK_EV::[ReadyToRead?]} */
            if (RESET != I2C_GetFlagStatus( s_I2C_Bus[me->iBus].i2c_bus, I2C_FLAG_RXNE )) {
                ...
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::ReadI2CByte::I2C_CHECK_EV::[ReadyToRead?]::[>1byteleft?]} */
                ...
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::ReadI2CByte::I2C_CHECK_EV::[ReadyToRead?]::[else]} */
                else {
            ...
            /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::ReadI2CByte::I2C_CHECK_EV::[else]} */
            else {
                me->nI2CLoopTimeout--;                 /* Decrement counter */
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::ReadI2CByte::I2C_CHECK_EV::[else]::[Retriesleft?]} */
                if (me->nI2CLoopTimeout != 0) {
                    status_ = Q_TRAN(&I2CBusMgr_ReadI2CByte);
                }
                /* ${AOs::I2CBusMgr::SM::Active::Busy::BusBeingUsed::Reading::ReadI2CByte::I2C_CHECK_EV::[else]::[else]} */
                else {
                    ERR_printf("Timeout waiting for I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED (EV6)\n");
                    status_ = Q_TRAN(&I2CBusMgr_Idle);
                }
 ...
 * machine is going next.
 */
/*${AOs::I2CBusMgr::SM::Active::Busy::WaitFor_I2C_EV5_REC} .................*/
static QState I2CBusMgr_WaitFor_I2C_EV5_REC(I2CBusMgr * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        /* ${AOs::I2CBusMgr::SM::Active::Busy::WaitFor_I2C_EV5_REC} */
        ...
        /* ${AOs::I2CBusMgr::SM::Active::Busy::WaitFor_I2C_EV5_REC::I2C_CHECK_EV} */
        case I2C_CHECK_EV_SIG: {
            /* Check if EV5 has happened.  If it has, go on to the next state.  Otherwise,
             * try again until number of retries is out */
            /* ${AOs::I2CBusMgr::SM::Active::Busy::WaitFor_I2C_EV5_REC::I2C_CHECK_EV::[EV5Happened?]} */
            if (I2C_CheckEvent(s_I2C_Bus[me->iBus].i2c_bus, I2C_EVENT_MASTER_MODE_SELECT)) {
                ...
                /* Reset the maximum number of times to poll the I2C bus for an event */
                me->nI2CLoopTimeout = MAX_I2C_TIMEOUT;
                status_ = Q_TRAN(&I2CBusMgr_WaitFor_I2C_EV6_REC);
            }
            /* ${AOs::I2CBusMgr::SM::Active::Busy::WaitFor_I2C_EV5_REC::I2C_CHECK_EV::[else]} */
            else {
                me->nI2CLoopTimeout--;                 /* Decrement counter */
                /* ${AOs::I2CBusMgr::SM::Active::Busy::WaitFor_I2C_EV5_REC::I2C_CHECK_EV::[else]::[Retriesleft?]} */
                if (me->nI2CLoopTimeout != 0) {
                    status_ = Q_TRAN(&I2CBusMgr_WaitFor_I2C_EV5_REC);
                }
                /* ${AOs::I2CBusMgr::SM::Active::Busy::WaitFor_I2C_EV5_REC::I2C_CHECK_EV::[else]::[else]} */
                else {
                    WRN_printf("Expected timeout waiting for EV5 after bus recovery\n");
                    status_ = Q_TRAN(&I2CBusMgr_StartI2CComm);
                }
            }
            break;
        }
 ...
 * machine is going next.
 */
/*${AOs::I2CBusMgr::SM::Active::Busy::WaitFor_I2C_EV6_REC} .................*/
static QState I2CBusMgr_WaitFor_I2C_EV6_REC(I2CBusMgr * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        /* ${AOs::I2CBusMgr::SM::Active::Busy::WaitFor_I2C_EV6_REC} */
        ...
        /* ${AOs::I2CBusMgr::SM::Active::Busy::WaitFor_I2C_EV6_REC::I2C_CHECK_EV} */
        case I2C_CHECK_EV_SIG: {
            /* Check if EV6 has happened.  If it has, go on to the next state.  Otherwise,
             * try again until number of retries is out */
            /* ${AOs::I2CBusMgr::SM::Active::Busy::WaitFor_I2C_EV6_REC::I2C_CHECK_EV::[EV6Happened?]} */
            if (I2C_CheckEvent( s_I2C_Bus[me->iBus].i2c_bus, I2C_EVENT_MASTER_TRANSMITTER_MODE_SELECTED )) {
                status_ = Q_TRAN(&I2CBusMgr_StartI2CComm);
            }
            /* ${AOs::I2CBusMgr::SM::Active::Busy::WaitFor_I2C_EV6_REC::I2C_CHECK_EV::[else]} */
            else {
                me->nI2CLoopTimeout--;                 /* Decrement counter */
                /* ${AOs::I2CBusMgr::SM::Active::Busy::WaitFor_I2C_EV6_REC::I2C_CHECK_EV::[else]::[Retriesleft?]} */
                if (me->nI2CLoopTimeout != 0) {
                    status_ = Q_TRAN(&I2CBusMgr_WaitFor_I2C_EV6_REC);
                }
                /* ${AOs::I2CBusMgr::SM::Active::Busy::WaitFor_I2C_EV6_REC::I2C_CHECK_EV::[else]::[else]} */
                else {
 ...
 * machine is going next.
 */
/*${AOs::I2CBusMgr::SM::Active::Busy::StartI2CComm} ........................*/
static QState I2CBusMgr_StartI2CComm(I2CBusMgr * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        /* ${AOs::I2CBusMgr::SM::Active::Busy::StartI2CComm} */
        ...
        /* ${AOs::I2CBusMgr::SM::Active::Busy::StartI2CComm::I2C_CHECK_EV} */
        case I2C_CHECK_EV_SIG: {
            /* Check if bus is busy.  If free, go on to the next state.  Otherwise,
             * try again until number of retries is out */
            /* ${AOs::I2CBusMgr::SM::Active::Busy::StartI2CComm::I2C_CHECK_EV::[BusFree?]} */
            ...
            /* ${AOs::I2CBusMgr::SM::Active::Busy::StartI2CComm::I2C_CHECK_EV::[else]} */
            else {
                status_ = Q_TRAN(&I2CBusMgr_TogglingSCL);
            }
            break;
 ...
 * machine is going next.
 */
/*${AOs::I2CBusMgr::SM::Active::Busy::WaitForBusToSettle} ..................*/
static QState I2CBusMgr_WaitForBusToSettle(I2CBusMgr * const me, QEvt const * const e) {
    QState status_;
    switch (e->sig) {
        /* ${AOs::I2CBusMgr::SM::Active::Busy::WaitForBusToSettle} */
        ...
        /* ${AOs::I2CBusMgr::SM::Active::Busy::WaitForBusToSettle::I2C_RECOVERY_TIMEOUT} */
...
static QState I2CBusMgr_Idle(I2CBusMgr * const me, QEvt const * const e) {
    ...
    switch (e->sig) {
        ...
        /* ${AOs::I2CBusMgr::SM::Active::Idle::I2C_READ_START} */
        ...
        /* ${AOs::I2CBusMgr::SM::Active::Idle::I2C_WRITE_START} */
        case I2C_WRITE_START_SIG: {
