...
static U32 GetPixelformat(int LayerIndex) 
{
   ...
   //dbg_slow_printf("BAD!!! no exit from here\n");
   while (1);
}
...
static void LCD_LL_Init(uint32_t LayerIndex) 
{
   ...
   if (Is_Initialized == 0)
   {
      //dbg_slow_printf("Clock enabling\n");
      Is_Initialized = 1;
...
//   dbg_slow_printf("enter with cmd %d\n", Cmd);
   int r = 0;
   int xPos, yPos;

   switch (Cmd) {
      case LCD_X_INITCONTROLLER: {
         dbg_slow_printf("LCD_X_INITCONTROLLER\n");
      ...
      case LCD_X_SHOWBUFFER: {
         //dbg_slow_printf("LCD_X_SHOWBUFFER\n");
      ...
      case LCD_X_SETLUTENTRY: {
         //dbg_slow_printf("LCD_X_SETLUTENTRY\n");
      ...
      case LCD_X_ON: {
         //dbg_slow_printf("LCD_X_ON\n");
         /* Required if the display controller should support switching on and off */
         LTDC_Cmd(ENABLE); /* display ON */
         //dbg_slow_printf("Finished\n");
         break;
      }
      case LCD_X_OFF: {
         //dbg_slow_printf("LCD_X_OFF\n");
         /* Required if the display controller should support switching on and off */
         LTDC_Cmd(DISABLE); /* display OFF */
         break;
      }
      case LCD_X_SETVIS: {
         //dbg_slow_printf("LCD_X_SETVIS\n");
      ...
      case LCD_X_SETALPHA: {
         //dbg_slow_printf("LCD_X_SETALPHA\n");
      ...
      case LCD_X_SETCHROMAMODE: {
         //dbg_slow_printf("LCD_X_SETCHROMAMODE\n");
      ...
      case LCD_X_SETCHROMA: {
         //dbg_slow_printf("LCD_X_SETCHROMA\n");
