...
/* Private variables and Local objects ---------------------------------------*/
   ...
   const char Menu1Txt[] = "Menu 1";

      static treeNode_t MenuItem1;
      const char MenuItem1_1Txt[] = "Menu Item 1.1";

      static treeNode_t MenuItem2;
      const char MenuItem1_2Txt[] = "Menu Item 1.2";

      static treeNode_t MenuItem3;
      const char MenuItem1_3Txt[] = "Menu Item 1.3";

      static treeNode_t MenuItem4;
      const char MenuItem1_4Txt[] = "Menu Item 1.4";

   static treeNode_t Menu2;
   const char Menu2Txt[] = "Menu 2";

      static treeNode_t MenuItem2_1;
      const char MenuItem2_1Txt[] = "Menu Item 2.1";

      static treeNode_t MenuItem2_2;
      const char MenuItem2_2Txt[] = "Menu Item 2.2";

      static treeNode_t MenuItem2_3;
      const char MenuItem2_3Txt[] = "Menu Item 2.3";

      static treeNode_t MenuItem2_4;
      const char MenuItem2_4Txt[] = "Menu Item 2.4";

   static treeNode_t Menu3;
   const char Menu3Txt[] = "Menu 3";

      static treeNode_t Menu3_1;
      const char Menu3_1Txt[] = "Menu 3_1";

         static treeNode_t MenuItem3_1_1;
         const char MenuItem3_1_1Txt[] = "Menu Item 3.1.1";

         static treeNode_t MenuItem3_1_2;
         const char MenuItem3_1_2Txt[] = "Menu Item 3.1.2";

         static treeNode_t MenuItem3_1_3;
         const char MenuItem3_1_3Txt[] = "Menu Item 3.1.3";

         static treeNode_t MenuItem3_1_4;
         const char MenuItem3_1_4Txt[] = "Menu Item 3.1.4";

      static treeNode_t Menu3_2;
      const char Menu3_2Txt[] = "Menu 3_2";

         static treeNode_t MenuItem3_2_1;
         const char MenuItem3_2_1Txt[] = "Menu Item 3.2.1";

         static treeNode_t MenuItem3_2_2;
         const char MenuItem3_2_2Txt[] = "Menu Item 3.2.2";

         static treeNode_t MenuItem3_2_3;
         const char MenuItem3_2_3Txt[] = "Menu Item 3.2.3";

         static treeNode_t MenuItem3_2_4;
         const char MenuItem3_2_4Txt[] = "Menu Item 3.2.4";

      static treeNode_t Menu3_3;
      const char Menu3_3Txt[] = "Menu 3_3";

         static treeNode_t Menu3_3_1;
         const char Menu3_3_1Txt[] = "Menu 3_3_1";

            static treeNode_t MenuItem3_3_1_1;
            const char MenuItem3_3_1_1Txt[] = "Menu Item 3.3.1.1";

            static treeNode_t MenuItem3_3_1_2;
            const char MenuItem3_3_1_2Txt[] = "Menu Item 3.3.1.2";

            static treeNode_t MenuItem3_3_1_3;
            const char MenuItem3_3_1_3Txt[] = "Menu Item 3.3.1.3";

         static treeNode_t Menu3_3_2;
         const char Menu3_3_2Txt[] = "Menu 3_3_2";

            static treeNode_t MenuItem3_3_2_1;
            const char MenuItem3_3_2_1Txt[] = "Menu Item 3.3.2.1";

            static treeNode_t MenuItem3_3_2_2;
            const char MenuItem3_3_2_2Txt[] = "Menu Item 3.3.2.2";

            static treeNode_t MenuItem3_3_2_3;
            const char MenuItem3_3_2_3Txt[] = "Menu Item 3.3.2.3";

         static treeNode_t Menu3_3_3;
         const char Menu3_3_3Txt[] = "Menu 3_3_3";

            static treeNode_t MenuItem3_3_3_1;
            const char MenuItem3_3_3_1Txt[] = "Menu Item 3.3.3.1";

            static treeNode_t MenuItem3_3_3_2;
            const char MenuItem3_3_3_2Txt[] = "Menu Item 3.3.3.2";

            static treeNode_t MenuItem3_3_3_3;
            const char MenuItem3_3_3_3Txt[] = "Menu Item 3.3.3.3";

         static treeNode_t Menu3_3_4;
         const char Menu3_3_4Txt[] = "Menu 3_3_4";

            static treeNode_t MenuItem3_3_4_1;
            const char MenuItem3_3_4_1Txt[] = "Menu Item 3.3.4.1";

            static treeNode_t MenuItem3_3_4_2;
            const char MenuItem3_3_4_2Txt[] = "Menu Item 3.3.4.2";

            static treeNode_t MenuItem3_3_4_3;
            const char MenuItem3_3_4_3Txt[] = "Menu Item 3.3.4.3";
...
)
{
   ...
   if ( NULL == trueParentNode->firstChildNode ) {
      ...
      dbg_slow_printf("Child exists at node '%s', looking at siblings for child node '%s'\n", trueParentNode->text, trueParentNode->firstChildNode->text);
      KTREE_addNextSibling( childToAdd, trueParentNode->firstChildNode, trueParentNode);
...
{
   /* Find the last sibling node in this line of siblings */
   treeNode_t *lastSibling = KTREE_getLastSibling( trueParentNode );
