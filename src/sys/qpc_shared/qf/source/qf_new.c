...
/*..........................................................................*/
QEvt *QF_new_(QEvtSize const evtSize, char *filex, int line)
...
#endif
{
    ...
    while (evtSize > QF_EPOOL_EVENT_SIZE_(QF_pool_[idx])) {
        ...
        if (idx >= QF_maxPool_) {
           printf("\n\n From %s, %d\n", filex, line);
           printf("Pre assert in QF_NEW: event_enum_num=%d, evtSize=%u, pool size = %u, QF_maxPool_=%u\n",
             sig, evtSize, QF_EPOOL_EVENT_SIZE_(QF_pool_[idx]), QF_maxPool_);
        }
